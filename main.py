...
def main():
    ...
    try:
        ...
        print("  JobDatabase not found. Printing results to console only.")
        db = None
    ...
    if telegram_cfg.get('enabled', False):
        ...
        if not bot_token or not chat_id:
            print(" Telegram credentials missing in .env (TELEGRAM_BOT_TOKEN, TELEGRAM_CHAT_ID)")
        else:
            ...
            if sent == 0:
                notifier.send_message(" No job alerts were sent. Check logs for details.")
            else:
